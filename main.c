...
int main(void)
{
    ...
    xTaskCreate( vaccineProductionTask, VACCINE_TASK_NAME, TASK_STACK_SIZE, NULL, VACCINE_PRIORITY, &vaccineHandler);
    xTaskCreate( medicineProductionTask, MEDICINE_TASK_NAME, TASK_STACK_SIZE, NULL, MEDICINE_PRIORITY, &medicineHandler);
